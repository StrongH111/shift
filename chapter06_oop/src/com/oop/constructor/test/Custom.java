...
信息*/
    ...
    public static void main(String[] args) {
        ...
        c.setAccount(a,2000,1.23/100,1000);
        c.getAccount(a);
        c.a.
    }
    ...
    public void setAccount(Account a, double balance, double annualInterestRate, int id) {
        a.setId(id);
        a.setBalance(balance);
        a.setAnnualIntereatRate(annualInterestRate);
